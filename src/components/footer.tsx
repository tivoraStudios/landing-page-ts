          ...
          <LogoAndSocials>
            ...
            <Socials>
              <Link
                ...
                target="_blank"
              >
                <Image src={InstaIconSrc} alt="instagram icon" />
              </Link>
              <Link
                href="https://www.tiktok.com/@tivorastudios"
                target="_blank"
              >
                <Image src={TiktokIconSrc} alt="tiktok icon" />
              </Link>
              <Link
                href="https://www.linkedin.com/company/tivorastudios"
                target="_blank"
              >
                <Image src={LinkedinIconSrc} alt="youtube icon" />
              </Link>
            </Socials>
          </LogoAndSocials>
          <CopyRight>© tivorastudios {new Date().getFullYear()}</CopyRight>
        </FooterTextWrapper>
      </Wrapper>
      <WaitListModal
